...
//Expected: FORGOT YOUR PASSWORD?
        ...
        String actualforgotPasswordLink = "FORGOT YOUR PASSWORD?";
        String expectedforgotPasswordLink = forgotPasswordLink.getText();
...
//Expected: forgot_password=yes
     //   WebElement forgotPassword = driver.findElement(By.className("login-link-forgot-pass"));
       String actualForgotPasswordAttribute = forgotPasswordLink.getAttribute("href");
