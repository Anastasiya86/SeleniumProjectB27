...
public class T2_StaleElementReferenceException {
    public static void main(String[] args) {
        ...
        // System.out.println("deleteBtn.isDisplayed() = " + deleteBtn.isDisplayed()); gives us the Stale Element exception and we use try and catch block , so we can run the rest of the code
        //we cannot see if delete button is displayed, because it is already gone from the page, no way to verify it
